...
export default function ReportesCuentasPorCobrar() {
  ...
  const [resultados, setResultados] = useState([
    ...
    },
    {
      ...
      cliente: "Distribuidora García",
      tipoCliente: "Mayorista",
      fechaFactura: "2024-02-20",
    ...
    <div className="flex h-screen overflow-hidden bg-background">
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-6">
          <div className="mb-6">
            <h1 className="text-3xl font-bold">Reporte de Cuentas por Cobrar</h1>
            <p className="text-muted-foreground">Filtre y analice las cuentas por cobrar con múltiples criterios</p>
          </div>
              ...
              <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) => setFiltros({ ...filtros, tipoCliente: value })}
                  >
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>{resultados.length} facturas encontradas</CardDescription>
                </div>
                  ...
                  <TableBody>
                    {resultados.map((resultado) => (
                      <TableRow key={resultado.id}>
                        <TableCell className="font-medium">{resultado.factura}</TableCell>
                        <TableCell>{resultado.cliente}</TableCell>
                        <TableCell>{resultado.tipoCliente}</TableCell>
